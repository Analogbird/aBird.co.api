...
var config = require('../config'),
	...
	modeler = require('../library/modeler'),
	...
	shrinkURL = function content$shrinkURL (req, res, next, type) {
		...
		if (validator.isURL(url)) {
			 ...
			 */
			modeler.findOneAndUpdate('content',
				{ 'data.value': url },
...
module.exports = {
	...
	shrink : function content$shrink (req, res, next) {
	...
	expand : function content$expand (req, res, next) {
